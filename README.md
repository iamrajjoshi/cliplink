...
The npm package is `cliplink`; the command is `clip`. See [Raj's clips](https://clip.rajjoshi.me) for a working collection. The [product landing page](docs/site.md) lives in `site/` and can be previewed independently.
